...
export function ProcesoCard({ proceso, esHijo = false, proyectoId, esInterno = false }: { proceso: ProcesoConHijos; esHijo?: boolean; proyectoId: string; esInterno?: boolean }) {
  ...
  // La proyección de impacto (antes "Proyecciones e Impacto" en esta
  // tarjeta) se mueve por completo a Horizonte de Impacto (F5) — acá ya no
  // se genera ni se muestra, para no duplicar esa función en dos pantallas.
